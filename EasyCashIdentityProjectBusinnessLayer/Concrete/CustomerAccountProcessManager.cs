using EasyCashIdentityProjectBusinnessLayer.Abstract;
using EasyCashIdentityProjectDataAccessLayer.Abstract;
using EasyCashIdentityProjectEntityLayer.Concreate;
using System;
...
namespace EasyCashIdentityProjectBusinnessLayer.Concrete
{
